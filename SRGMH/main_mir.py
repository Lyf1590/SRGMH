...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='MIRFlickr', help='MIRFlickr, NUS-WIDE or COCO', type=str)
    parser.add_argument('--alpha_train', type=float, default=0.2, help='Missing ratio of train set--image.')
    ...
    parser.add_argument('--K', default=3000, help='3000,3500,3700', type=int)
    parser.add_argument('--K1', default=30, type=int, help='number of Missing ratio: 30、70、110、150')
    parser.add_argument('--temperature', default=4, help='1', type=float)
