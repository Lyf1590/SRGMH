...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='COCO', help='MIRFlickr, NUS-WIDE or COCO', type=str)
    parser.add_argument('--alpha_train', type=float, default=0.8, help='Missing ratio of train set--image.')
    parser.add_argument('--beta_train', type=float, default=0.5, help='Missing ratio of query set--txt.')
    ...
    parser.add_argument('--lambda1', default=8, type=float, help='8')
    parser.add_argument('--lambda2', default=1, type=float, help='1')
    parser.add_argument('--beta', default=1, type=float, help='1')
    parser.add_argument('--LR_IMG', default=0.0005, type=float, help='0.0001')
    parser.add_argument('--LR_TXT', default=0.0005, type=float, help='0.0001')
    ...
    parser.add_argument('--K', default=3000, help='3600', type=int)
    parser.add_argument('--K1', default=30, type=int, help='number of Missing ratio: 30、70、110、150')
    parser.add_argument('--temperature', default=4, help='1', type=int)
    parser.add_argument('--a1', default=0.3, help='balance ST and SI (0.6)', type=float)
    parser.add_argument('--a2', default=0.1, help='balance S1 and S2 (0.6)', type=float)
